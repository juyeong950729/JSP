	...
	<body>
		...
		<form action="/Ch09/user4/modify.do" method="post">
			<table border="1">
				...
				<tr>
					<td>성별</td>
					<td><input type="text" name="gender" placeholder="${vo.gender}"></td>
				</tr>
				<tr>
					<td>나이</td>
					<td><input type="text" name="age" placeholder="${vo.age}"></td>
				</tr>
				<tr>
					<td>주소</td>
					<td><input type="text" name="addr" placeholder="${vo.addr}"></td>
				</tr>
				<tr>
